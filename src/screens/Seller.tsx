...
function Seller() {
    ...
    async function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        try {
            ...
            const res = await privateClient.post("/property/add",{
                ...values,
            })
            ...
            <div className="md:w-[400px]">
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                        ...
                        />
                        <Button className="px-8" type="submit">Post Your Property</Button>
                    </form>
                </Form>
            </div>
        </div>
